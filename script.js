...
Level.prototype.obstacleAt = function(position , size){
  var startX = Math.floor(position.x);
  var startY = Math.floor(position.y);
...
var wobbleSpeed = 8 , wobbleDistance = 0.07;

Coin.prototype.act = function(step , level){
...
var arrows = trackKeys(arrowCode);
